...
**StealThis.dev** is a curated open-source library of reusable web resources — animations, pages, UI components, and patterns — all free to use and copy.

## Browse the Library

Head to [stealthis.dev/library](/library) to see all resources. You can filter by:
...
Every resource page includes code in multiple targets:
